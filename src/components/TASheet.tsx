      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 print:shadow-none print:border-none print:p-0 overflow-x-auto print:overflow-visible">
        {matchesToRender.map((match, index) => (
          <div key={`${match.ringNo}-${match.matchNo}-${index}`} className="w-full min-w-[700px] max-w-[1000px] mx-auto bg-white print:min-w-0 print:max-w-none print:w-full page-break mb-8 print:mb-0" style={{ fontFamily: 'Arial, sans-serif' }}>
            ...
            {/* Match Info */}
            <table className="w-full border-collapse border border-black mb-2 print:mb-4 text-sm font-bold match-info-table table-fixed">
              <colgroup>
                <col style={{ width: '22%' }} />
                <col style={{ width: '45%' }} />
          ...
          {/* Round Scores */}
          <table className="w-full border-collapse border border-black mb-2 print:mb-2 text-sm text-center font-bold table-fixed">
            <colgroup>
              <col style={{ width: '8%' }} />
              <col style={{ width: '12%' }} />
              <col style={{ width: '12%' }} />
          ...
          <table className="w-full border-collapse border border-black mb-2 print:mb-2 text-[10px] text-center font-bold table-fixed">
            <colgroup>
          ...
          <table className="w-full border-collapse border border-black mb-2 print:mb-2 text-xs text-center font-bold table-fixed">
            <colgroup>
              <col style={{ width: '18%' }} />
